	...
	<?php
		...
		$comments_args = array(
			...
			'comment_field' =>
				 ...
				 <textarea id="comment" name="comment" aria-requird="true" placeholder="Skriv in din kommentar!" rows="8" cols="45" wrap="hard"></textarea></p>' ,
				'fields' => apply_fillters( 'comment_form_default_fields', array(
